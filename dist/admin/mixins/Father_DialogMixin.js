...
import Father_BaseVue, { MyComponent, MyGetter, MyProp, MyWatch, } from './Father_BaseVue';
let Father_DialogMixin = 
// export default class HelloWorld extends BaseVueClass {
class Father_DialogMixin extends Father_BaseVue.Mixins(Father_ExportExcel_Mixin) {
    constructor() {
        super(...arguments);
    ...
    async beforeUpload() {
        const preUploadData = (await this.preuploadApi());
        if (preUploadData) {
