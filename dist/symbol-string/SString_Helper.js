export class SString_Helper {
     ...
     * @returns {string}
     */
    starMask_Phone(_phone, format = 'center', _count = 4) {
        const phone = _phone + '';
        let count = _count;
     ...
     */
    starMask_Email(email, _maxCount = 5) {
     ...
     * 【文件】的体积大小，格式化显示。
     */
    static formatFileSize(bytes_num, fixed_num = 0) {
     ...
     * 文本超出内容，用【省略号】代替
     */
    static ellipsisText(text, num = text.length) {
     ...
     */
    static outOfNum_99plus(_num, _maxNum) {
