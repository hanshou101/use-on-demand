<template>
	<div class="multi-lang-simple-com">
		<el-tabs type="border-card" v-model="selectedCard" @tab-click="clickTab">
			...
			<el-tab-pane :label="$t('lang.English')" data-label="英文" v-if="en_US">
			...
			<el-tab-pane :label="$t('lang.Korean')" data-label="韩文" v-if="ko_KR">
				<slot name="ko_KR"></slot>
			</el-tab-pane>
			<el-tab-pane :label="$t('lang.Japanese')" data-label="日文" v-if="ja_JP">
				<slot name="ja_JP"></slot>
			</el-tab-pane>
			<el-tab-pane :label="$t('俄文')" data-label="俄文" v-if="ru_RU">
