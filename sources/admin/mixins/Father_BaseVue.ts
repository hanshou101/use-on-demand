 ...
 */
export abstract class xX_Father_BaseVue extends Vue {					// FIXME 最后这是唯一开箱即用的方法？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？
	...
	public constructor() {
		super();
		const count = ++xX_Father_BaseVue.NoticeCount;
		if (count <= 3) {
 ...
 */
export const Wrong_Father_BaseVue: Father_BaseVue_Static = xX_Father_BaseVue as any;		// FIXME 为什么这种方法不可用？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？
