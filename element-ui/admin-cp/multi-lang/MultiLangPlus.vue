...
<script lang="ts">
  ...
  import BaseVue, {MixinLevelTag} from "../../../_framework/BaseVue";
  ...
  export default class MultiLangPlus extends BaseVue {    // 混入在此处，进行添加。
    ...
    translate (data: any) {
      return CommonApi.translate(data);
    }
    ...
    public created (): void {
      ...
      let _langRules = this.multiLangRules();
