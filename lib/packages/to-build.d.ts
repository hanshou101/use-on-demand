 ...
 */
export declare const HelloWorld: import("vue").VueConstructor<HelloWorldCfg.HelloWorldCp>;
export declare const VideoJS: import("vue").VueConstructor<HelloWorldCfg.HelloWorldCp>;
