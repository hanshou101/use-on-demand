declare function installByRequire(Vue: VueConstructor_Type, opts?: {}): void;
declare const _default: {
    install: typeof installByRequire;
};
/**
 * 导出之后，【其它项目】的使用方法：
...
export declare const VideoJS: any;
//# sourceMappingURL=to-build____backup.d.ts.map