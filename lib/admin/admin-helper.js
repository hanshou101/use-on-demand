export class AdminHelper {
     ...
     */
    static combine_MultiLangPlus(type, formObj, netField, localField = 'translate') {
        switch (type) {
            // 上传到接口
            case 'upload':
     ...
     * 处理时间段选择
     */
    static formDateRange(params, form) {
     ...
     *          1.目前，经常用于【提交数据】的筛选。
     */
    static filterTargetFields(originObj, filterObj, needTrimEmpty = false) {
        const distObj = {
