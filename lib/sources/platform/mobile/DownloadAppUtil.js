...
var CheckAddressNew_Util = /** @class */ (function () {
    function CheckAddressNew_Util(updateTime) {
        if (updateTime === void 0) { updateTime = new Date().valueOf(); }
        this.updateTime = updateTime;
        this.aliveDuration = 1 * 1000; // 一分钟
    }
    CheckAddressNew_Util.prototype.checkOrRefresh = function (refreshFn) {
    ...
    return CheckAddressNew_Util;
}());
export { CheckAddressNew_Util };
var DownloadAppUtil = /** @class */ (function () {
     ...
     *
     */
    DownloadAppUtil.autoDownload = function (option) {
     ...
     *
     */
    DownloadAppUtil.downloadAndroid = function (androidUrl) {
        // TIP 安卓配置
        if (androidUrl) {
     ...
     *
     */
    DownloadAppUtil.downloadIOS = function (iosUrl, autoJoinProtocol, // 是否自动拼接，【itms-services】协议头。默认为是。
    callback) {
