var FullScreen_Helper = /** @class */ (function () {
    function FullScreen_Helper() {
    }
    /**
     * 进入全屏
     */
    FullScreen_Helper.prototype.fullScreen = function (el) {
     ...
     * 退出全屏
     */
    FullScreen_Helper.prototype.exitScreen = function () {
     ...
     * 获取【全屏事件】监听的【更强工具类】。
     */
    FullScreen_Helper.prototype.get_ChangeEvtListen_Util = function () {
        return new WatchFullScreenUtil();
    };
    return FullScreen_Helper;
}());
export { FullScreen_Helper };
