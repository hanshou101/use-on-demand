...
var ImgLazyLoad_Directive = /** @class */ (function () {
    function ImgLazyLoad_Directive() {
    }
    /**
     * 将图片插入
     */
    ImgLazyLoad_Directive.__showImage = function (el, imgSrc) {
        var img = new Image();
        img.src = imgSrc;
        img.onload = function () {
            el.src = imgSrc;
     ...
     * 获得一个监听器
     */
    ImgLazyLoad_Directive.__getObserver = function () {
        var _this = this;
    ...
    ImgLazyLoad_Directive.getDirective = function (placeholderImg) {
        var timer;
        var observer = ImgLazyLoad_Directive.__getObserver();
        var _directive = {
            /**
            ...
            inserted: function (el, binding, vnode) {
                ...
                timer = window.setTimeout(function () {
                    // 在【组件卸载之前】，停止监听器
                    vm === null || vm === void 0 ? void 0 : vm.$on(VHookE.beforeDestroy, function () {
    ...
    return ImgLazyLoad_Directive;
}());
export { ImgLazyLoad_Directive };
