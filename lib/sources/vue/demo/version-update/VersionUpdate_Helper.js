...
var VersionUpdate_Helper = /** @class */ (function () {
    function VersionUpdate_Helper() {
    }
    VersionUpdate_Helper.getCheckUrl = function () {
        return location.origin + "/" + this.vFileName + "?_=" + Math.random();
    };
    /**
     * 在路由跳转中，检查【版本更新】。
     */
    VersionUpdate_Helper.checkVersion = function () {
        var _this = this;
        ...
        if (nowTs - this.lastCheckTs > this.checkIntervalTs) { // 如果，距离上次【检测更新】，已超过了【最小检测更新间隔时间】。
            ...
            axios.get(this.getCheckUrl()).then(function (_a) {
                ...
                DebugU.l(LogE.versionCheck, '当前检查更新的时间戳为：', _this.lastCheckTs);
                // 暂时不作，当前环境的检测。
     ...
     */
    VersionUpdate_Helper.setVersion_onBuild = function (config, versionFilePath) {
        var _a;
        if (versionFilePath === void 0) { versionFilePath = "public/" + VersionUpdate_Helper.vFileName; }
    ...
    return VersionUpdate_Helper;
}());
export { VersionUpdate_Helper };
