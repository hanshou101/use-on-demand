...
var SArray_Helper = /** @class */ (function () {
    function SArray_Helper() {
    }
    /**
     * 获取数组中符合条件的元素的索引
     * @param arr 数组
     ...
     */
    SArray_Helper.getIndex_fromRule = function (arr, fn) {
     ...
     */
    SArray_Helper.prototype.getNewArray_NoRepeat = function (arr, _isObjectValue) {
        if (!arr || arr.length === 0) {
            return arr;
        }
     ...
     */
    SArray_Helper.prototype.convertObjectKey_InOriginArr = function (arr, keyConvertPair, delOriginAttrValue) {
        if (!arr || arr.length == 0) {
            return;
            // return arr;
        }
     ...
     * @param seriesArr
     */
    SArray_Helper.prototype.get_NewArray_Accumulate_SigmaSummary = function (seriesArr) {
     ...
     */
    SArray_Helper.prototype.shuffle_rtnNew = function (rawArr) {
        var j;
        var x;
        var i;
     ...
     * 数组去重。
     */
    SArray_Helper.prototype.noRepeat_rtnNew = function (rawArr) {
        return __spread(new Set(rawArr)); // 快速去重
    };
    return SArray_Helper;
}());
export { SArray_Helper };
