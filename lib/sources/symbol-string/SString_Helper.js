var SString_Helper = /** @class */ (function () {
    function SString_Helper() {
    }
    /**
     * 创建一个【独一无二】的【随机字符串】
     */
    SString_Helper.create_RandUnique_Str = function () {
     ...
     * @returns {string}
     */
    SString_Helper.prototype.starMask_Phone = function (_phone, format, _count) {
     ...
     */
    SString_Helper.prototype.starMask_Email = function (email, _maxCount) {
     ...
     * 【文件】的体积大小，格式化显示。
     */
    SString_Helper.formatFileSize = function (bytes_num, fixed_num) {
     ...
     * 文本超出内容，用【省略号】代替
     */
    SString_Helper.ellipsisText = function (text, num) {
     ...
     */
    SString_Helper.outOfNum_99plus = function (_num, _maxNum) {
    ...
    return SString_Helper;
}());
export { SString_Helper };
