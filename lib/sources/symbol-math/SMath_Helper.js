...
var xX_SMath_Helper = /** @class */ (function () {
    function xX_SMath_Helper() {
    }
    /**
     * 科学计数法转化的工具。
     */
    xX_SMath_Helper.scienceNumber_transToPlainText = function (num) {
        // 如果【非数字格式】，则返回
        if (isNaN(num)) {
            return num;
        }
     ...
     * 随机整数。
     */
    xX_SMath_Helper.randomInt = function (min, max) {
     ...
     * 数字添加千分位符
     */
    xX_SMath_Helper.parseToThousandth = function (num, point) {
    ...
    return xX_SMath_Helper;
}());
export { xX_SMath_Helper };
