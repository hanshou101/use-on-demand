var AdminHelper = /** @class */ (function () {
     ...
     */
    AdminHelper.combine_MultiLangPlus = function (type, formObj, netField, localField) {
     ...
     * 处理时间段选择
     */
    AdminHelper.formDateRange = function (params, form) {
     ...
     *          1.目前，经常用于【提交数据】的筛选。
     */
    AdminHelper.filterTargetFields = function (originObj, filterObj, needTrimEmpty) {
