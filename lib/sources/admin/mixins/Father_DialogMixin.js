 ...
 * 可能最后，还是要用【Mixins】去解决！！！。
 */
var Father_DialogMixin = /** @class */ (function (_super) {
    __extends(Father_DialogMixin, _super);
    // export default class HelloWorld extends BaseVueClass {
    function Father_DialogMixin() {
    ...
    // TIP: watch 在类中的实现
    Father_DialogMixin.prototype.watch_show = function (newVal) {
    ...
    // TIP: methods 在类中的实现
    Father_DialogMixin.prototype.showDialog = function (type, row) {
    ...
    Father_DialogMixin.prototype.closeDialog = function () {
    ...
    Father_DialogMixin.prototype.submitForm = function (formName) {
        var _this = this;
    ...
    // 数据处理
    Father_DialogMixin.prototype._handleInitData = function (_data) {
    ...
    Father_DialogMixin.prototype._createItem = function () {
    ...
    Father_DialogMixin.prototype._updateItem = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
    ...
    Father_DialogMixin.prototype.handleUploadSuccess = function (response) {
    ...
    Father_DialogMixin.prototype.beforeUpload = function () {
        return __awaiter(this, void 0, void 0, function () {
