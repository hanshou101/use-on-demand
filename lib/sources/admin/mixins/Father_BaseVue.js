 ...
 */
var xX_Father_BaseVue = /** @class */ (function (_super) {
    __extends(xX_Father_BaseVue, _super);
    // noinspection TypeScriptAbstractClassConstructorCanBeMadeProtected		WARN 此处，必须暴露给外界为【public】，因为可能是【VueConstructor】的限制？
    function xX_Father_BaseVue() {
        var _this = _super.call(this) || this;
        var count = ++xX_Father_BaseVue.NoticeCount;
        if (count <= 3) {
    ...
    xX_Father_BaseVue.NoticeCount = 0; // 最多提醒3次。
    return xX_Father_BaseVue;
}(Vue));
export { xX_Father_BaseVue };
// & VueConstructor<Vue>;
/**
 * TIP 此处，是经过多次妥协的结果。（WARN 该结果是错的）
 */
export var Wrong_Father_BaseVue = xX_Father_BaseVue; // FIXME 为什么这种方法不可用？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？
