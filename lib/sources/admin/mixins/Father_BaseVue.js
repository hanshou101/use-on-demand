 ...
 */
var Father_BaseVue = /** @class */ (function (_super) {
    __extends(Father_BaseVue, _super);
    // noinspection TypeScriptAbstractClassConstructorCanBeMadeProtected		WARN 此处，必须暴露给外界为【public】，因为可能是【VueConstructor】的限制？
    function Father_BaseVue() {
        var _this = _super.call(this) || this;
        var count = ++Father_BaseVue.NoticeCount;
        if (count <= 3) {
    ...
    return Father_BaseVue;
}(Vue));
export { Father_BaseVue };
// & VueConstructor<Vue>;
/**
 * TIP 此处，是经过多次妥协的结果。（WARN 该结果是错的）
 */
export var Wrong_Father_BaseVue = Father_BaseVue; // FIXME 为什么这种方法不可用？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？
