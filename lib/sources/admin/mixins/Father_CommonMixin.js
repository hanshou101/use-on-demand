 ...
 * 全局CRUD组件抽取
 */
var Father_CommonMixin = /** @class */ (function (_super) {
    __extends(Father_CommonMixin, _super);
    function Father_CommonMixin() {
    ...
    //
    //
    Father_CommonMixin.prototype._getList = function () {
    ...
    Father_CommonMixin.prototype.submitForm = function (formName) {
        var _this = this;
    ...
    // TIP 当前选择项，发生了变化。
    Father_CommonMixin.prototype.handleSelectionChange = function (val) {
        this.deleteItems = val;
    };
    Father_CommonMixin.prototype.handleCreate = function () {
        var _this = this;
    ...
    Father_CommonMixin.prototype.handleEdit = function (index, row) {
        var _this = this;
        this.dialogControlVisible = true;
        this.$nextTick(function () {
    ...
    Father_CommonMixin.prototype.handleDetail = function (index, row) {
        var _this = this;
        this.dialogControlVisible = true;
        this.$nextTick(function () {
    ...
    // FIXME 这一条，是已经过时的老方法
    // FIXME 这一条，是已经过时的老方法
    Father_CommonMixin.prototype.handleDeleteSingle = function (index, row) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    // 批量删除数据
    Father_CommonMixin.prototype.handleDelete = function () {
        var _this = this;
    ...
    Father_CommonMixin.prototype.handleChangeStatus = function (index, row) {
        return __awaiter(this, void 0, void 0, function () {
            var id, status;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Father_CommonMixin.prototype.handlePageChange = function (currentPage) {
        this.listQuery.current = currentPage;
        this._getList();
    };
    Father_CommonMixin.prototype._deleteItems = function () {
        return __awaiter(this, void 0, void 0, function () {
            var ids;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Father_CommonMixin.prototype.deleteSingle = function (index, data_or_row_or_id) {
        return __awaiter(this, void 0, void 0, function () {
            var cbFn;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    Father_CommonMixin.prototype.beforeUpload = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    // }
    // 关闭对话框的毁掉
    Father_CommonMixin.prototype.closeDialogEvent = function () {
    ...
    //
    // TIP 生命周期
    Father_CommonMixin.prototype.beforeCreate = function () {
    ...
    // TIP 生命周期
    Father_CommonMixin.prototype.mounted = function () {
    ...
    Father_CommonMixin.prototype.activated = function () {
    ...
    Father_CommonMixin.prototype.updated = function () {
    };
    // TIP 生命周期（在<Keep-Alive>进入后台之后。）
    Father_CommonMixin.prototype.deactivated = function () {
    };
    Father_CommonMixin.prototype.destroyed = function () {
    };
    __decorate([
        Getter('language'),
    ...
    return Father_CommonMixin;
}(Mixins(Father_ExportExcel_Mixin)));
