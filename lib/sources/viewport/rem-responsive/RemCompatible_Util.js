 ...
 */
var My_RemCompatible_Util = /** @class */ (function () {
    function My_RemCompatible_Util() {
    }
    My_RemCompatible_Util.rem2px = function (v) {
        var _v = parseFloat(v);
        return _v * this.rem;
    };
    My_RemCompatible_Util.px2rem = function (v) {
        var _v = parseFloat(v);
        return _v / this.rem;
    };
    /**
     *
     */
    My_RemCompatible_Util.calc_remCompatible_YanNan = function (designWidth, // 设计图尺寸
    adjustRatio) {
        var _this = this;
    ...
    return My_RemCompatible_Util;
}());
export { My_RemCompatible_Util };
