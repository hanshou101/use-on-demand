var xX_SDateTime_Helper = /** @class */ (function () {
    function xX_SDateTime_Helper() {
    }
    /**
     * 根据指定时间的倒计时功能
     */
    xX_SDateTime_Helper.prototype.countDownForTime = function (__endTime, // 结束时间
    ...
    xX_SDateTime_Helper.getTimePartStr = function (ms) {
        var s = ms / 1000;
     ...
     *        1.举例："1"，变为"01"。
     */
    xX_SDateTime_Helper.completeTimePartZero = function (timePart) {
        return parseInt(timePart) < 10 ?
            '0' + String(timePart)
            : String(timePart);
    };
    return xX_SDateTime_Helper;
}());
export { xX_SDateTime_Helper };
var xX_ServerTime_Helper = /** @class */ (function () {
    function xX_ServerTime_Helper() {
    }
    /**
     *  保存【时间差值】
     */
    xX_ServerTime_Helper.saveDiffTime = function (header) {
     ...
     *  获取【服务器真实】当下时间，时间戳。
     */
    xX_ServerTime_Helper.getServer_NowTime_Ts = function () {
        return new Date().getTime() + this.diffTime;
    };
    /**
     *  获取【服务器真实】目标时间，时间戳。
     */
    xX_ServerTime_Helper.getServer_TargetTime_Ts = function (targetTimeStr) {
     ...
     *          2.毫秒为单位。
     */
    xX_ServerTime_Helper.diffTime = 0;
    return xX_ServerTime_Helper;
}());
export { xX_ServerTime_Helper };
