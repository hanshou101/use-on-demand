var JqQrcode_Helper = /** @class */ (function () {
    function JqQrcode_Helper() {
    }
    JqQrcode_Helper.drawQrcode = function ($, qrTxt, wH, jDom) {
        var _a;
        if (!window.jQuery) {
            window.jQuery = $;
        }
    ...
    return JqQrcode_Helper;
}());
export { JqQrcode_Helper };
