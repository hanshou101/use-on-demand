var DomStyle_Helper = /** @class */ (function () {
    function DomStyle_Helper() {
    }
    /**
     * 获取元素的css属性值
     */
    DomStyle_Helper.getDomStyle = function (ele, // 元素
    cssAttribute) {
        if (!ele || !ele.nodeName) {
     ...
     * 【浏览器窗口】，内部内容区域，宽高
     */
    DomStyle_Helper.getDocumentWidthHeight = function () {
     ...
     */
    DomStyle_Helper.get_AbsoluteOffset_Position = function (ele) {
        var position = {
            top: 0,
            left: 0,
        };
     ...
     */
    DomStyle_Helper.get_eB2wB_eR2wR = function (e) {
        // alert('尺寸改变，开始检测');
        var domAttr = {
     ...
     *        1.无限个层级，都有效，
     */
    DomStyle_Helper.isContains_otherEle = function (ele, // 父级元素
    _childEle) {
     ...
     */
    DomStyle_Helper.fix_AndroidKeyboard_errorVH = function (timeout) {
     ...
     * 浏览器，是否支持【某个CSS属性】
     */
    DomStyle_Helper.prototype.isSupport_CssProperty = function (key) {
    ...
    return DomStyle_Helper;
}());
export { DomStyle_Helper };
/**
