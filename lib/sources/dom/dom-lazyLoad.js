...
(function (EchoNS) {
    ...
    var Echo = /** @class */ (function () {
        ...
        Echo.prototype.render = function (context) {
            var _a, _b;
            // 查找，所有的相关节点。
            var nodes = (context || document).querySelectorAll(Echo._selector.join(' , '));
         ...
         * 						1.则，【新建定时器】。
         */
        Echo.prototype.__ScrollOrLoad_debounceOrThrottle = function () {
            var _this = this;
         ...
         */
        Echo.__isDisplayNone = function (element) {
