...
const __MyTrackballControls = function (object, domElement) {
    const that = this;
    ...
    let _state = STATE.NONE, _prevState = STATE.NONE;
    const _eye = new THREE.Vector3(), _movePrev = new THREE.Vector2(), _moveCurr = new THREE.Vector2(), _lastAxis = new THREE.Vector3();
    let _lastAngle = 0;
    const _zoomStart = new THREE.Vector2(), _zoomEnd = new THREE.Vector2();
    let _touchZoomDistanceStart = 0, _touchZoomDistanceEnd = 0;
    const _panStart = new THREE.Vector2(), _panEnd = new THREE.Vector2();
    // for reset
    ...
    this.rotateCamera = (function () {
        const axis = new THREE.Vector3(), quaternion = new THREE.Quaternion(), eyeDirection = new THREE.Vector3(), objectUpDirection = new THREE.Vector3(), objectSidewaysDirection = new THREE.Vector3(), moveDirection = new THREE.Vector3();
        let angle;
