...
var BaseThreeClass = /** @class */ (function () {
    function BaseThreeClass(_container) {
    ...
    Object.defineProperty(BaseThreeClass.prototype, "_width", {
        get: function () {
    ...
    Object.defineProperty(BaseThreeClass.prototype, "_height", {
        get: function () {
    ...
    return BaseThreeClass;
}());
export { BaseThreeClass };
var MyPoint3D = /** @class */ (function () {
...
var My_YuanZhu_Option = /** @class */ (function () {
    function My_YuanZhu_Option(geometry, material, position) {
        this.geometry = geometry;
        this.material = material;
        this.position = position;
    }
    return My_YuanZhu_Option;
}());
export { My_YuanZhu_Option };
var My_LiFangTi_Option = /** @class */ (function () {
    function My_LiFangTi_Option(geometry, material, position) {
        this.geometry = geometry;
        this.material = material;
        this.position = position;
    }
    return My_LiFangTi_Option;
}());
export { My_LiFangTi_Option };
var My_CommonLine_Option = /** @class */ (function () {
    function My_CommonLine_Option(geometry, material, position) {
        this.geometry = geometry;
        this.material = material;
        this.position = position;
    }
    return My_CommonLine_Option;
}());
export { My_CommonLine_Option };
var My_ColorLine_Option = /** @class */ (function () {
    function My_ColorLine_Option(geometry, material, position) {
        this.geometry = geometry;
        this.material = material;
        this.position = position;
    }
    return My_ColorLine_Option;
}());
export { My_ColorLine_Option };
var BaseThreeClass_Helper = /** @class */ (function () {
    function BaseThreeClass_Helper() {
    }
    // // 创建一个Object3D对象，并进行返回。
    // abstract create<T>(): T;
    // TODO 将来，这里可以写一些通用的，工具类方法。
    BaseThreeClass_Helper.prototype.my_Default_Scene = function (threeClass, options) {
        var scene = new THREE.Scene();
        // scene = scene;
        return scene;
    };
    BaseThreeClass_Helper.prototype.my_Default_Camera = function (threeClass, options) {
    ...
    BaseThreeClass_Helper.prototype.my_DefaultRenderer_haveNotAppend = function (threeClass, options) {
    ...
    BaseThreeClass_Helper.prototype.my_Default_LightsBundle_haveNotAdd = function (threeClass, options) {
    ...
    BaseThreeClass_Helper.prototype.my_Default_Object_haveNotAdd = function (threeClass, options) {
        var _a;
        /**
         * 1.Mesh贴面物体
         *        1.1 形状：
    ...
    return BaseThreeClass_Helper;
}());
export { BaseThreeClass_Helper };
