...
var xX_DepuTable_three95 = /** @class */ (function () {
    function xX_DepuTable_three95() {
     ...
     *            2.【检验手机平台：适配】
     */
    xX_DepuTable_three95.prototype.startDepu = function () {
        //
    ...
    // TIP 检测手机平台
    xX_DepuTable_three95.prototype.checkUserAgent = function () {
     ...
     */
    // 构建辅助网格系统（模拟地砖效果）
    xX_DepuTable_three95.prototype.buildAuxSystem = function () {
        // 绘制网格线
    ...
    xX_DepuTable_three95.prototype.buildLightSystem = function () {
    ...
    // 创建桌子
    xX_DepuTable_three95.prototype.buildTable = function () {
        var tableShape = TableHelper.roundedRect(-100, -50, 200, 100, 50);
        var tableGeometry = xX_MyThree_Util.makeExtrudeGeometry(tableShape, 10);
        var tableMesh = xX_MyThree_Util.makeMesh('lambert', tableGeometry, 0x274C2B);
        tableMesh.position.y = 0;
        this.scene.add(tableMesh);
    };
    // 创建扑克
    xX_DepuTable_three95.prototype.buildPoker = function () {
    ...
    // TIP 循环执行代码
    xX_DepuTable_three95.prototype.loop = function () {
        // stats.update()
        this.renderer.render(this.scene, this.camera);
        requestAnimationFrame(this.loop.bind(this));
    };
    // TIP 监听浏览器窗口大小变化
    xX_DepuTable_three95.prototype.onWindowResize = function () {
        var _this = this;
    ...
    return xX_DepuTable_three95;
}());
export { xX_DepuTable_three95 };
...
var PokerHelper = /** @class */ (function () {
    ...
    PokerHelper.createOne_EmptyPoker = function (w, h) {
        ...
        var pokerGeometry = xX_MyThree_Util.makeExtrudeGeometry(pokerShape, 0.3);
        var pokerMesh = xX_MyThree_Util.makeMesh('lambert', pokerGeometry, 0xFFFFFF);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, xX_MyThree_Util.asyncLoad_textureLoader(path)];
                    case 1:
