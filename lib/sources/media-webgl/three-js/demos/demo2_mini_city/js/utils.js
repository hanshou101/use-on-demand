...
var MyThree_Util = /** @class */ (function () {
    function MyThree_Util() {
    }
    /**
     ...
     */
    MyThree_Util.makeShape = function (shapeCoords) {
     ...
     */
    MyThree_Util.makeExtrudeGeometry = function (shape, amount) {
        var extrudeSetting = {
            steps: 1,
            amount: amount,
            bevelEnabled: false,
     ...
     * phong：适合金属、镜面。
     */
    MyThree_Util.makeMesh = function (materialType, geometry, color) {
        var material;
     ...
     * 路径点 ————> 多边形模子 ————> 形状。
     */
    MyThree_Util.makeShapeGeometry = function (shapeCoords) {
     ...
     * 异步加载【Texture纹理文件】
     */
    MyThree_Util.asyncLoad_textureLoader = function (path) {
