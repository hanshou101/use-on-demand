...
export class MyThree_Util {
     ...
     */
    static makeShape(shapeCoords, ...manyHolesCoords_Arr) {
     ...
     */
    static makeExtrudeGeometry(shape, amount) {
     ...
     * phong：适合金属、镜面。
     */
    static makeMesh(materialType, geometry, color) {
        let material;
     ...
     * 路径点 ————> 多边形模子 ————> 形状。
     */
    static makeShapeGeometry(shapeCoords) {
     ...
     * 异步加载【Texture纹理文件】
     */
    static asyncLoad_textureLoader(path) {
