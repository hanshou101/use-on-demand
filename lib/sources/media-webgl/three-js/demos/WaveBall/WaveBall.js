...
var xX_WebGL_WaveBall_Demo_three56 = /** @class */ (function () {
    function xX_WebGL_WaveBall_Demo_three56() {
        var _this = this;
        this.SEPARATION = 100;
        this.AMOUNTX = 50;
        this.AMOUNTY = 50;
    ...
    // animate();
    xX_WebGL_WaveBall_Demo_three56.prototype.initAll = function (box) {
        var _a;
        ...
        (_a = document.addEventListener) === null || _a === void 0 ? void 0 : _a.call(document, 'mousemove', this.onDocumentMouseMove, false);
        //
        window.addEventListener('resize', this.onWindowResize, false);
        this.animate();
    };
    xX_WebGL_WaveBall_Demo_three56.prototype.render = function () {
        // 鼠标移动时，镜头旋转的效果
    ...
    return xX_WebGL_WaveBall_Demo_three56;
}());
export { xX_WebGL_WaveBall_Demo_three56 };
