export declare enum xX_GeeStableE {
...
export declare class xX_GeeStableUtil {
    /**
    ...
    success: SuccessType): xX_GeeStableE;
    /**
     * 获取【网络请求】的【极验Header】。
     */
    static getRequest_GeeHeader({ geetest_challenge, geetest_validate, geetest_seccode }: SdkVerifyFingerResNS._RawData_SucType, sign: string, geeStatus: xX_GeeStableE): {
