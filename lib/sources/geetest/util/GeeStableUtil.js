export var GeeStableE;
(function (GeeStableE) {
    // 以下两个，header是{}
    GeeStableE["NoGeetest_false_0"] = "NoGeetest_false_0";
    GeeStableE["NoGeetest_false_1"] = "NoGeetest_false_1";
    // 以下，header是{sign}
    GeeStableE["ErrorGeetest__true_0"] = "ErrorGeetest__true_0";
    // 以下，header是{3个值}
    GeeStableE["SuccessGeetest_true_1"] = "SuccessGeetest_true_1";
})(GeeStableE || (GeeStableE = {}));
var GeeStableUtil = /** @class */ (function () {
    function GeeStableUtil() {
    }
    /**
     ...
     *        3.不可用。
     */
    GeeStableUtil.calcCurrent_GeeStable = function (enable, // WARN 这个值，有可能是undefined
    success) {
     ...
     * 获取【网络请求】的【极验Header】。
     */
    GeeStableUtil.getRequest_GeeHeader = function (_a, sign, geeStatus) {
    ...
    return GeeStableUtil;
}());
export { GeeStableUtil };
