...
var GeeBzUtil = /** @class */ (function () {
    function GeeBzUtil() {
    }
    /**
     * 内部SDK调用，唤起一次极验。
     */
    GeeBzUtil.__innerSdkInit = function (data, toListen_GeeCtrlCbs) {
    ...
    GeeBzUtil.beginGee = function (preInfoApi, onFingerSuc, // WARN 此处，不采用Promise的原因，是Promise天然适合【立即执行Verify】的逻辑；可能造成误解。
    immediateVerify) {
        var _this = this;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        stableE = GeeStableUtil.calcCurrent_GeeStable(enable, success);
                        _a = stableE;
                        switch (_a) {
                            case GeeStableE.NoGeetest_false_0: return [3 /*break*/, 2];
                            case GeeStableE.NoGeetest_false_1: return [3 /*break*/, 2];
                            case GeeStableE.ErrorGeetest__true_0: return [3 /*break*/, 3];
                            case GeeStableE.SuccessGeetest_true_1: return [3 /*break*/, 4];
                        }
                        return [3 /*break*/, 6];
                    case 2:
                        {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, GeeBzUtil.__innerSdkInit(data, {
