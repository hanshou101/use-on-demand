...
var xX_CVS_Excel_Helper = /** @class */ (function () {
    function xX_CVS_Excel_Helper() {
    }
    /**
     * 先将二维数组转成纯文本，重点是要处理可能在内容中出现的分隔符和双引号：
     */
    xX_CVS_Excel_Helper.arrayToCsv = function (data, args) {
        if (args === void 0) { args = {}; }
     ...
     */
    xX_CVS_Excel_Helper.exportCsv = function (inputData, filename) {
     ...
     * 从【】，触发【下载Excel】操作
     */
    xX_CVS_Excel_Helper.downloadExcel = function (url, filename) {
     ...
     * 从Excel文件中，获取某些行列。
     */
    xX_CVS_Excel_Helper.readArr_fromExcel = function (excel_file, // 传入的Excel文件
    sheet_field, // 筛选特定字段
    inputDom) {
            ...
            getXLSX().then(function (XLSX) {
                ...
                var fileOnLoadCb = function (event) {
                    ...
                    for (var sheet in _sheets) {
                        // 安全判断，是否有该属性
                        if (Object.prototype.hasOwnProperty.call(_sheets, sheet)) {
                            // 表格范围
     ...
     * 将文本，导出为【ZIP文件】
     */
    xX_CVS_Excel_Helper.prototype.export_txt_to_zip = function (th, jsonData, txtName, zipName) {
        return new Promise(function (resolve, reject) {
     ...
     *
     */
    xX_CVS_Excel_Helper.export_table_to_excel = function (id) {
    ...
    xX_CVS_Excel_Helper.prototype.export_json_to_excel = function (_a) {
    ...
    return xX_CVS_Excel_Helper;
}());
export { xX_CVS_Excel_Helper };
//
//
//
//
