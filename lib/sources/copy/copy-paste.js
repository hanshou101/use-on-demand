...
var CopyPaste_Util = /** @class */ (function () {
    function CopyPaste_Util() {
    }
    // 简单复制
    CopyPaste_Util.prototype.simpleCopy = function (selector) {
        var clipboard = new Clipboard(selector);
        return clipboard;
    };
    // 带回调的赋值
    CopyPaste_Util.prototype.copyWithCb = function (selector, sucCb, errCb) {
    ...
    // 指定复制过程中的一些选项
    CopyPaste_Util.prototype.specialCopy = function (selector, options) {
    ...
    // 销毁Clipboard对象
    CopyPaste_Util.prototype.destroy = function (clipboard) {
        clipboard.destroy();
    };
    return CopyPaste_Util;
}());
export { CopyPaste_Util };
