...
var CDecoratorU = /** @class */ (function () {
    function CDecoratorU() {
    }
    /**
     *  防抖
     *        1.【若干秒之后】，才执行，必定执行一次。
     */
    CDecoratorU.debounce = function (wait, immediate) {
     ...
     */
    CDecoratorU.throttle = function (wait, /*immediate: boolean = false*/ __options) {
     ...
     * 执行1次，若干秒内，都不执行
     */
    CDecoratorU.runOnlyOnce_inDuration = function () {
        // TODO 暂时还没想好。
    };
    /**
     * Loading加载提示
     */
    CDecoratorU.loading = function () {
    };
    /**
     * 确认框
     */
    CDecoratorU.ConfirmDialog = function () {
    };
    /**
     * 应用于成员方法之上
     ...
     */
    CDecoratorU.log = function (that, type) {
