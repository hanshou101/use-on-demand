 ...
 */
var Rt_UEditor_Helper = /** @class */ (function () {
    function Rt_UEditor_Helper() {
    }
    Rt_UEditor_Helper.initUEditor = function (vue, apiUrl) {
    ...
    // TIP——————————————————————————————————
    Rt_UEditor_Helper.get_VueUeditorWrap = function () {
        // @ts-ignore
        return import('vue-ueditor-wrap');
    };
    return Rt_UEditor_Helper;
}());
export { Rt_UEditor_Helper };
