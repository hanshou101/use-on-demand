...
import { xX_MyFormItem_SelectOptionConf } from './MyElementUtils';
    ...
    var Options = /** @class */ (function (_super) {
        ...
        function Options(require, optional) {
            ...
            if (require) {
                ...
                _this.selectOptionConf = new xX_MyFormItem_SelectOptionConf(selectOptionConf.option).setParseInt(selectOptionConf.needParseInt);
            }
            return _this;
        }
        return Options;
