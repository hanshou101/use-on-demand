...
(function (Old) {
    ...
    Old.xX_MyFormItem_SelectOptionConf = xX_MyFormItem_SelectOptionConf;
})(Old || (Old = {}));
// tslint:disable-next-line:no-namespace
export var xX_Father_ElFItem;
(function (xX_Father_ElFItem) {
    ...
    xX_Father_ElFItem.TextArea = TextArea;
    // 抽象基类
    ...
    xX_Father_ElFItem.I18N_PureText_SingleLineInput = I18N_PureText_SingleLineInput;
    /**
     * TIP 【纯文本】多语言输入：多行
    ...
    xX_Father_ElFItem.I18N_PureText_TextArea = I18N_PureText_TextArea;
    // TIP 【富文本】单一语言输入：tinymce
    var Single_RichText_Tinymce = /** @class */ (function (_super) {
        __extends(Single_RichText_Tinymce, _super);
        function Single_RichText_Tinymce(require, optional) {
            var _this = _super.call(this, require, optional) || this;
            _this.myCategory = 'lang_single_tinymce'; // 该属性，不能使用static。否则Vue将不会取到。
            return _this;
        }
        return Single_RichText_Tinymce;
    }(Base__Translate));
    xX_Father_ElFItem.Single_RichText_Tinymce = Single_RichText_Tinymce;
    ...
    xX_Father_ElFItem.I18N_RichText_UEditor = I18N_RichText_UEditor;
    ...
    xX_Father_ElFItem.Password = Password;
    ...
    xX_Father_ElFItem.Number = Number;
    ...
    xX_Father_ElFItem.NumberRange = NumberRange;
    ...
    xX_Father_ElFItem.UploadImg = UploadImg;
    var Options = /** @class */ (function (_super) {
        ...
        function Options(require, optional) {
            ...
            if (require) {
                ...
                _this.selectOptionConf = new Old.xX_MyFormItem_SelectOptionConf(selectOptionConf.option).setParseInt(selectOptionConf.needParseInt);
            }
            return _this;
        }
        return Options;
    }(Base));
    xX_Father_ElFItem.Options = Options;
    ...
    xX_Father_ElFItem.SingleTime = SingleTime;
    ...
    xX_Father_ElFItem.SingleDate = SingleDate;
    ...
    xX_Father_ElFItem.TimeRange = TimeRange;
    ...
    xX_Father_ElFItem.DateRange = DateRange;
    ...
    xX_Father_ElFItem.DateTimeRange = DateTimeRange;
    ...
    xX_Father_ElFItem.DateTimeRangeBtn = DateTimeRangeBtn;
})(xX_Father_ElFItem || (xX_Father_ElFItem = {}));
