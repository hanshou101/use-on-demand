...
var L2Dwidget = function (t) {
  ...
  })('versions', []).push({version: r.version, mode: e(17) ? 'pure' : 'global', copyright: '© 2019 Denis Pushkarev (zloirock.ru)'});
}, function (t, n) {
  t.exports = !1;
}, function (t, n) {
  ...
  'use strict';
  var r     = e(17), o = e(12), i = e(5), c = e(4), u = e(8), a = e(49), s = e(24), f = e(56), l = e(0)('iterator'), p = !([].keys && 'next' in [].keys()), d = function () {
    return this;
  };
  t.exports = function (t, n, e, v, h, y, m) {
    ...
    if (E && (g = f(E.call(new t))) !== Object.prototype && g.next && (s(g, _, !0), r || 'function' == typeof g[l] || c(g, l, d)), P && S && 'values' !== S.name && (O = !0, k = function () {
      return S.call(this);
    }), r && !m || !p && !O && j[l] || c(j, l, k), u[n] = k, u[_] = d, h) if (b = {values: P ? k : x('values'), keys: y ? k : x('keys'), entries: T}, m) for (w in b) w in j || i(j, w, b[w]); else o(o.P + o.F * (p || O), n, b);
    return b;
  };
}, function (t, n, e) {
  var r     = e(52), o = e(31);
  ...
  window.device = i;
  var u         = window.document.documentElement, a = window.navigator.userAgent.toLowerCase(), s = ['googletv', 'viera', 'smarttv', 'internet.tv', 'netcast', 'nettv', 'appletv', 'boxee', 'kylo', 'roku', 'dlnadoc', 'pov_tv', 'hbbtv', 'ce-html'];
  ...
  'use strict';
  var r, o, i, c, u = e(17), a = e(1), s = e(13), f = e(15), l = e(12), p = e(6), d = e(14), v = e(63), h = e(64), y = e(33), m = e(34).set, b = e(69)(), w = e(25), g = e(35), x = e(70), _ = e(36), P = a.TypeError, O = a.process, j = O && O.versions, S = j && j.v8 || '', k = a.Promise, T = 'process' == f(O), E = function () {
  }, L              = o = w.f, M = !!function () {
    try {
    ...
    m.call(a, function () {
      ...
      if (i && (n = g(function () {
        T ? O.emit('unhandledRejection', o, t) : (e = a.onunhandledrejection) ? e({promise: t, reason: o}) : (r = a.console) && r.error && r.error('Unhandled promise rejection', o);
  ...
  var r     = e(1), o = e(34).set, i = r.MutationObserver || r.WebKitMutationObserver, c = r.process, u = r.Promise, a = 'process' == e(9)(c);
  t.exports = function () {
