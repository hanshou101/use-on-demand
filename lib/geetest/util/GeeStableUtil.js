...
export class GeeStableUtil {
     ...
     *        3.不可用。
     */
    static calcCurrent_GeeStable(enable, // WARN 这个值，有可能是undefined
    success) {
     ...
     * 获取【网络请求】的【极验Header】。
     */
    static getRequest_GeeHeader({ geetest_challenge, geetest_validate, geetest_seccode }, sign, geeStatus) {
        switch (geeStatus) {
